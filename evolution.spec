...
Patch0001: 0001-composer-smime-triple-wrap.patch
...
- Release the inner enveloped part when the outer signature fails
- Unreference the outer signed part only after its content is last used
...
- Sign the enveloped-data part rather than the whole message, which was
  duplicating the message headers into the signed body
- Remove the encrypt-step headers left on the message

* Sat Jun 06 2026 Mike Ward <mward5@tinfoil-fedora.com> - 3.60.2-1.triplewrap1
- Add triple-wrap S/MIME composer patches for Gmail Workspace compatibility
